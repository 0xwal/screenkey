...
REPLACE_SYMS = {
    # Regular keys
    'Escape':       KeyRepl(True,  True,  True,  _('🛫')),
    'Tab':          KeyRepl(True,  False, False, _('➡️')),
    'ISO_Left_Tab': KeyRepl(True,  False, False, _('➡️')),
    'Return':       KeyRepl(True,  False, False, _('↩️')),
    'space':        KeyRepl(False, False, False, _('🪐')),
    'BackSpace':    KeyRepl(True,  True,  False, _('⬅️')),
...
REPLACE_MODS = {
    ...
    'ctrl':   {'normal': _('©️+'),  'emacs': 'C-', 'mac': _('⌘+')},
    'alt':    {'normal': _('🅰️+'),   'emacs': 'M-', 'mac': _('⌥+')},
    'super':  {'normal': _('🦸+'), 'emacs': 's-',
